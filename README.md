...
This API follows an HTTP scheme authentication, called Bearer authentication, to autheticate every request. Every request must contain the Authorization header with a valid token generated by Firebase SDK.
